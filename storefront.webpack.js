...
module.exports = () => ({
  resolve: {
    alias: {
      ...
      './html/AccountGamification.html': path.resolve(__dirname, 'template/js/custom-js/html/AccountGamification.html'),
      './js/AccountGamification.js': path.resolve(__dirname, 'template/js/custom-js/html/AccountGamification.js'),
      './vue/gamificacao.vue': path.resolve(__dirname, 'template/js/custom-js/components/gamificacao.vue'),
