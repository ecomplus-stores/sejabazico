...
(function() {
	...
	// Initialize "On Visible" animations.
		onvisible.add('h1.style6, h2.style6, h3.style6, p.style6', { style: 'fade-up', speed: 500, intensity: 0, threshold: 3, delay: 0, replay: true });
		onvisible.add('.image.style2', { style: 'fade-left', speed: 500, intensity: 0, threshold: 3, delay: 0, replay: false });
		onvisible.add('h1.style2, h2.style2, h3.style2, p.style2', { style: 'fade-up', speed: 500, intensity: 0, threshold: 3, delay: 0, replay: false });
		onvisible.add('h1.style3, h2.style3, h3.style3, p.style3', { style: 'fade-up', speed: 500, intensity: 1, threshold: 3, delay: 0, replay: false });
		onvisible.add('.buttons.style1', { style: 'fade-up', speed: 500, intensity: 2, threshold: 3, delay: 0, replay: false });
		onvisible.add('h1.style5, h2.style5, h3.style5, p.style5', { style: 'fade-left', speed: 500, intensity: 0, threshold: 3, delay: 0, replay: false });
		onvisible.add('.container.style1', { style: 'fade-up', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('.container.style1 > .wrapper > .inner', { style: 'fade-in', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('.image.style1', { style: 'fade-up', speed: 750, intensity: 3, threshold: 3, delay: 125, replay: false });
		onvisible.add('h1.style7, h2.style7, h3.style7, p.style7', { style: 'fade-up', speed: 500, intensity: 0, threshold: 3, delay: 0, replay: false });
